...
const Portfolio = () => {
  ...
  useEffect(() => {
    Axios.get("https://my-portfolio-luis.herokuapp.com/api/projects")
      .then((res) => {
    ...
    <div id="projects" className="portfolio">
      ...
      {!loading ? (
        <div className="portfolio-cont">
          {projects.map((item) => (
            <Projects item={item} key={item.id} toggleModal={toggleModal} />
          ))}
        </div>
      ) : (
            ...
            <div className="modal-content">
              ...
              <div className="modal-btn">
                ...
                <a
                  ...
                  href={indProject.github_repo}
                  target="a_blank"
                >
                  <button>Github/Docs</button>
                </a>
              </div>
            </div>
            <div
